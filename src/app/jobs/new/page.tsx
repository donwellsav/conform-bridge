    ...
    <div className="space-y-6">
      <PageHeader
        ...
        description={dataMode === "imported"
          ...
          : "Structured draft flow for bundle intake, template policy, mapping assumptions, and validation. Deterministic fallback bundles remain available until an intake fixture folder is present."}
        actions={
